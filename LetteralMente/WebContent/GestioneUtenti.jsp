...
<div class="container-fluid utenti bg-danger ">
        ...
        <h1 class="col-9 offset-3 pt-5 text-center "><b>Gestione utenti</b></h1>
                ...
                <table class="table">
                    ...
                    <tbody>
                                                ...
                                                <form action="Registrazione" method="post">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-xl-6 pt-1">
                                                            ...
                                                            <input type="email" name="datadinascita"
                                                                class="form-control pl-4 shadow p-1 mb-1 bg-white"
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-xl-6 pt-1">
                                                            <label for="cpwid">Password </label>
                                                            <input type="email" name="confpassword"
                                                                class="form-control pl-4 shadow p-1 mb-1 bg-white"
                        ...
                        <tr class="chiaro">
                            ...
                            <td class="text-center pt-4">2</td>
                            <td class="text-center pt-4">
                                <p> <a data-toggle="collapse" data-target="#demo3" role="button" aria-expanded="false"
                                        aria-controls="collapseExample">
