                    ...
                    <% }else{
                        Utente u= (Utente) request.getSession().getAttribute("utenteLoggato"); %> 
                           ...
                           <div class="dropdown">
                           		 ...
                           		 <button class="buttonHead dropdown-toggle px-3" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-cog float-left mr-2 my-auto " ></i></button>     
