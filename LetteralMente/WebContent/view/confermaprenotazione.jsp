...
if(p!=null){%>
    <div class="row ">
      ...
      <div class="col-xl-7 offset-1 pt-3 text-center">
        ...
        <p class="mt-3 mb-5" style="font-style:italic;">Nei prossimi minuti le sarà inviata un email <br> con il codice del suo ordine e le istruzioni per il ritiro.</p>
